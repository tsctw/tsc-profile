      ...
      <div className="flex flex-col h-2/3 justify-center items-center basis-1/2">
        {isLoad ? <CodeMirrorComponent code={code} setCode={setCode} setShowRunButton={setShowRunButton} />
          : <div className="w-full m-b-0 flex flex-col h-full justify-center items-center">
            <div className="bg-zinc-700 dark:bg-slate-200 h-7 flex items-center gap-2 pl-2 rounded-t-lg w-full">
            ...
            <div>
              <div style={{ height: '200px' }} role="status" className="flex justify-center items-center w-full bg-code-light dark:bg-white">
                <div role="status">
