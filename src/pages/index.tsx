    ...
    <div className="h-full flex flex-row justify-center items-center">
      <div className="flex flex-col h-2/3 justify-center items-center basis-1/2">
        <div className="w-full m-b-0 flex flex-col h-full justify-center items-center">
          ...
          <div>
            {isLoad ? <CodeMirrorComponent code={code} setCode={setCode} setShowRunButton={setShowRunButton} codeMirrorWidth={codeMirrorWidth} />
              : <div style={{ height: '200px', width: `${codeMirrorWidth}px` }} role="status" className="flex justify-center items-center bg-code-light dark:bg-white">
                <div role="status">
