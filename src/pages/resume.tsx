...
const Resume = () => {
  return (
    <div className="h-full">
      <div className="text-2xl text-white font-bold pt-10 pl-10">Resume</div>
      <div className="flex">
        <div className="w-1/2">
          <div>
            <div className="text-xl text-white pt-10 pl-10">Work
        ...
        <div className="w-1/2">
          <div>
            <div className="text-xl text-white pt-10 pl-10">
              Education
            </div>
