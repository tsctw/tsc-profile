  ...
  return (
    <>
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col justify-between">
        <div>
          <Img fluid={image?.node?.childImageSharp?.fluid} alt="Your Image" />
          <div className="p-5">
        ...
        <div className="pl-5 pb-5">
          <a href={sourceUrl} className="mt-3 me-2 inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-sky-600 dark:bg-sky-800 rounded-lg hover:bg-blue-500 dark:hover:bg-blue-700">
            <span className="mr-1">Source Code</span>
            <FontAwesomeIcon icon={faCode} width={14} height={14} />
          </a>
          {sourceUrl2 && <a href={sourceUrl2} className="mt-3 me-2 inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-sky-600 dark:bg-sky-800 rounded-lg hover:bg-blue-500 dark:hover:bg-blue-700">
            <span className="mr-1">Source Code2</span>
            <FontAwesomeIcon icon={faCode} width={14} height={14} />
          </a>}
          {demoUrl && <a href={demoUrl} className="mt-3 inline-flex items-center px-2 py-1 text-xs font-medium text-center text-white bg-sky-600 dark:bg-sky-800 rounded-lg hover:bg-blue-500 dark:hover:bg-blue-700">
            Demo
