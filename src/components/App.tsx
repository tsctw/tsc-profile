  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center h-screen bg-stone-400 dark:bg-gray-200 body overflow-hidden">
        <div className="w-full h-full normal:w-5/6 normal:h-4/5 bg-gray-200 dark:bg-zinc-800 normal:rounded-3xl pb-16 normal:pb-0">
          <MainView {...props} />
        </div>
        ...
        {/* when screen width < 1024px */}
        <div className="normal:hidden absolute z-10 w-72 small:w-full h-16 max-w-lg -translate-x-1/2 bottom-4 left-1/2 text-xl">
          <ControlBar />
        </div>
      </div>
    </div>
