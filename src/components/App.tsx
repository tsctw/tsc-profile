...
export const App = (props: PageProps) => {
  return (
    <div className="flex justify-center items-center h-screen bg-stone-400 dark:bg-gray-200 body overflow-hidden">
      <div className="w-full h-full normal:w-5/6 normal:h-4/5 bg-gray-200 dark:bg-zinc-800 normal:rounded-3xl">
        <MainView {...props} />
      </div>
      ...
      <div className="normal:hidden fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
