...
export const Slider = () => {
  ...
  return (
    <div className="flex gap-4 flex-col justify-around items-center 
      ...
      <Link className="hover:text-orange-500" to={`${routers[currentPath].next}`}><FontAwesomeIcon icon={faChevronRight} /></Link>
      <Link className="hover:text-orange-500" to={`${routers[currentPath].prev}`}><FontAwesomeIcon icon={faChevronLeft} /></Link>
    </div>
  );
};